...
python tools/dataset/build_union_json_from_processed.py \
  --processed-dir /data2/xujr/anicontrol-20k/processed_data \
  --out-json /data2/xujr/anicontrol-20k/union_manifest.json \
  --controls-root /data2/xujr/anicontrol-20k/controls_root \
